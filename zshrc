...
echo 'eval "$(/opt/homebrew/bin/brew shellenv)"' >> /Users/hadrienmorand/.zprofile
...
export PYTHONPATH="/Users/hadrienmorand/code/hadri96/data-challenges/04-Decision-Science:$PYTHONPATH"
